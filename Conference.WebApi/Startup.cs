...
using ConferenceSystem.WebApi.Swagger;
using MediatR;
...
using ConferenceSystem.WebApi.MediatorPipeline;
using ConferenceSystem.WebApi.Middleware;
...
namespace ConferenceSystem.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMediatR(new[] { typeof(ListOfConferences).Assembly, typeof(AllEventsHandler).Assembly }); // get all IRequestHandler and INotificationHandler classes
